...
import { Upload, FileJson, Trophy, Activity, Briefcase, ChevronDown, Sparkles } from 'lucide-react';
              ...
              <div className="flex flex-col gap-4">
                {results.slice(0, 10).map((r) => (
                  <motion.div 
                    ...
                    transition={{ duration: 0.4, delay: r.rank * 0.1 }}
                    key={r.candidate_id} 
